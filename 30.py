...
print('=== BEFORE')
print('Rectangle points count: {}'.format(len(contours[RECT])))
print('Hexagon points count: {}'.format(len(contours[HEXAGON])))

approx_rect = cv2.approxPolyDP(contours[RECT], 30, True)
approx_hex = cv2.approxPolyDP(contours[HEXAGON], 30, True)

print('=== AFTER')
print('Rectangle points count: {}'.format(len(approx_rect)))
print('Hexagon points count: {}'.format(len(approx_hex)))
